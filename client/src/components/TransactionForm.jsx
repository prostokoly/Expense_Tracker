...
const TransactionForm = ({ onTransactionCreated }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const categoryName =
            currentCategories.find((c) => c.id === formData.categoryId)?.name ||
            "Без категории";
            ...
            >
                <button
                    ...
                    style={{
                        ...
                        borderRadius: "10px",
                        backgroundColor:
                            formData.type === "expense" ? "#e74c3c" : "white",
                        color:
                            formData.type === "expense" ? "white" : "#2c3e50",
                        cursor: "pointer",
                        fontSize: "16px",
                        fontWeight: "600",
                        flex: 1,
                ...
                <button
                    ...
                    style={{
                        ...
                        borderRadius: "10px",
                        backgroundColor:
                            formData.type === "income" ? "#27ae60" : "white",
